...
app_bar.setAttribute("class","app-bar");
app_bar.innerHTML = `        <div class="bar-font title">Guvi Hackathon - Sudoku</div>

   <button onclick="restartButtonClick()" ripple-color="#003c8f" class="button bar-button more-button">

            <span id="pause-text">Reset</span>
   </button>
...
ham.setAttribute("class","hamburger-menu");
ham.setAttribute("id","hamburger-menu");
ham.innerHTML = `  <nav id="nav-menu" class="nav-menu">
            <div class="nav-head">
...
floating.setAttribute("class","floaing");
floating.innerHTML =	`<button onclick="showDialogClick('dialog');" class="button floating-btn vertical-adjust">
            New Game
        </button>`;
...
dialog.innerHTML = `        <div id="dialog-box" class="dialog-content">
...
var sudo_body = document.createElement("div");	
sudo_body.setAttribute("class","body");
sudo_body.setAttribute("id","sudoku");

var game = document.createElement("div");	
game.setAttribute("class","card game");
game.innerHTML = `<table id="puzzle-grid">
                <tr>
                    <td>
...
var card_status = document.createElement("div");	
card_status.setAttribute("class","card status");
card_status.innerHTML = ` <div id="game-number">game #0</div>
...
sudo_body.append(game,card_status);
container.append(app_bar,ham,floating,dialog,sudo_body);
